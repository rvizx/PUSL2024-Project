        ...
        <nav class="p-5 bg-black shadow md:flex md:items-center md:justify-between">
            <div class="flex justify-between item-center">
                <span class="cursor-pointer">
                    <a href="index.jsp">
                        <img class="h-10 inline" src="/assets/images/abc_cinema_logo" alt="">
                    </a>
                </span>
...
<div align="center">
    ...
    <h1 class="text-white text-xl font-bold my-10">PAYMENT DONE. THANK YOU FOR PURCHASING OUR PRODUCT.</h1>
    <div>
