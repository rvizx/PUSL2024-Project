                    ...
                    <li class="nav-item">
                        ...
                        <div  >
                            <ul class="nav  sub-menu">
                                ...
                                <li class="nav-item active"> <a class="nav-link" href="/admin/managemovies.jsp">Manage Movies</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div  >
                            <ul class="nav  sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="/admin/stffdetails.jsp">Employee Details</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
