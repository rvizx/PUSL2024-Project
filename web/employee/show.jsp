                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="contact" method="post">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control"   placeholder="Show Date" name="showdate" required>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"  placeholder="Movie ID" name="movieid" required>
                      </div>
                      <div class="form-group">
